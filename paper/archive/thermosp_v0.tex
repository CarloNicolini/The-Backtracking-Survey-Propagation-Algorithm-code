...
Sullo stesso asse costruiamo una politica di decisione basata su risposte locali della free entropy, di cui un membro a vincolo duro \`e lo stimatore $I(k)$ della frazione di cluster compatibili con un'assegnazione gi\`a fissata.
Su istanze $3$-SAT e $4$-SAT, la politica $I(k)$ predice la variazione reale di $\Sig$ al rilascio con correlazione $r\simeq 0{,}997$ e migliora la dinamica della complessit\`a rispetto ai criteri di certainty e polarizzazione.
...
La temperatura di azione $\Ta$ deforma la politica di scelta fra azioni (decimare, backtrackare, scegliere il segno).
...
\end{equation}
e una politica di Gibbs a temperatura $\Ta$ sceglie
\begin{equation}
  \pi_{\Ta}(x_i=\sigma)
...
La politica di Gibbs sulla direzione usa
\begin{equation}
  P(x_i=\mathrm{vero})
...
La lettura in termini di free energy colloca $I(k)$ in una famiglia pi\`u ampia $(\Tc,\Ta,m,\gamma)$, di cui soltanto l'angolo duro della politica di rilascio \`e stato misurato in modo sistematico.
...
Abbiamo formulato la survey propagation termodinamica come deformazione di semianello dell'aggregazione cavitarie, con limite duro uguale a SP, e abbiamo collegato la politica di backtracking del BSP a risposte locali della free entropy.
