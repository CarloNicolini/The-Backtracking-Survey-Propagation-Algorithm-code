...
*K. Criterio appreso.* L'hook //#define NeurNET è già lì. Una volta prodotto il dataset diagnostico qui sotto, un modello su feature locali è la prosecuzione naturale — ma dopo, non prima.
