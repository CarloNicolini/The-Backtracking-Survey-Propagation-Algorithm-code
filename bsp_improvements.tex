...
A small neural net, trained to predict that drop from the local surveys, had an in-sample detection score near $0.95$ for harmful moves and then failed earlier than the bias $b_i$ when it was used to choose the assignment. On inspection it was largely reproducing the sign already contained in $w^+_i-w^-_i$.
